...
<body>
	<f:view>
		...
		<tr>
		<td></td>
		<td><h:commandLink action="#{fornitoreController.findFornitoreByNome(fornitore.nome)}" value="#{fornitore.nome}"/></td>
		</tr>
		</c:forEach>
		</table>
		</br>
...
<div>
							<h:commandLink action="#{prodottoController.findProdottoDaAggiornare(prodottoController.prodotto.id)}" value="Modifica prodotto"/>
			</div>
			<div>
							<h:commandLink action="#{prodottoController.aggiungiFornitore()}" value="Aggiungi Fornitore"/>
			</div>
						<div>
							<h:commandLink action="#{prodottoController.rimuoviFornitoreDaProdotto()}" value="Rimuovi Fornitore"/>
			</div>
			</c:if>
			<div>
							<a href='<c:url value="/faces/prodotti.jsp" />'>Torna
						al catalogo</a>
			</div>
		</h:form>
	</f:view>
